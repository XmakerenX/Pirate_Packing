...
BoxInfoWithID DBLF_core::bottomLeftFill(Item item)
{
	BoxInfoWithID placedPosition(QPoint3D(0, 0, 0), RGB(item.color.r / 256.0f, item.color.g / 256.0f, item.color.b / 256.0f),
...
std::vector<BoxInfoWithID> DBLF_core::getBoxPositions()
{
