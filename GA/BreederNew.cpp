...
void BreederNew::mateParents(Creature& parent1, Creature& parent2, std::vector<Creature>& population)
{

	//createChildren(parent1, parent2, PMX_StartIndex, PMX_EndIndex, population);
}
//------------------------------------------------------------------------------------------
std::vector<Creature> BreederNew::generateNextGeneration(std::vector<Creature> &currentPopulation)
{
...
int BreederNew::swapRepetition(std::unordered_map<int, int>& hash, int valueToSwap)
{
...
//------------------------------------------------------------------------------------------
void BreederNew::createChildren(Creature& parent1, Creature& parent2, int PMX_StartIndex, int PMX_EndIndex, std::vector<Creature>& population)
{
	int max, min;
...
//------------------------------------------------------------------------------------------
void BreederNew::mutateChild(Chromozome& chromozome)
{
